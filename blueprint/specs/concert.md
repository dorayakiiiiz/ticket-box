...
![BullMQ](https://img.shields.io/badge/BullMQ-Background_Jobs-854195?style=for-the-badge)
![Supabase](https://img.shields.io/badge/Supabase-Storage_&_Auth-3ECF8E?style=for-the-badge&logo=supabase&logoColor=white)
![AI](https://img.shields.io/badge/AI-Gemini_/_Groq-4285F4?style=for-the-badge&logo=google&logoColor=white)
...
- [2. Luồng Chính](#2-luồng-chính)
  - [2.1. Khởi Tạo Cache Redis khi Server Khởi Động (Warm-up)](#21-khởi-tạo-cache-redis-khi-server-khởi-động-warm-up)
  - [2.2. Tạo Concert Mới](#22-tạo-concert-mới)
  - [2.3. Cập Nhật Tiểu Sử Nghệ Sĩ bằng AI (Bất Đồng Bộ)](#23-cập-nhật-tiểu-sử-nghệ-sĩ-bằng-ai-bất-đồng-bộ)
  - [2.4. Client Polling Trạng Thái AI Bio](#24-client-polling-trạng-thái-ai-bio)
  - [2.5. Upload Ảnh Concert và Sơ Đồ Chỗ Ngồi](#25-upload-ảnh-concert-và-sơ-đồ-chỗ-ngồi)
  - [2.6. CRUD Loại Vé (TicketType)](#26-crud-loại-vé-tickettype)
  - [2.7. Truy Vấn Số Vé Còn Lại (Availability)](#27-truy-vấn-số-vé-còn-lại-availability)
  - [2.8. Xóa Concert (Soft Delete)](#28-xóa-concert-soft-delete)
...
sequenceDiagram
    ...
    DB-->>APP: Danh sach tat ca TicketType
...
sequenceDiagram
    ...
    BE->>BE: Multer limits: kiểm tra fileSize nho hon hoac bang 10MB

    alt File không phải PDF
        BE-->>FE: 400 "Chỉ chấp nhận file PDF"
    else File vuot quá 10MB
...
_Powered by NestJS, Redis, BullMQ, Supabase Storage & Gemini AI_
