                      ...
                      <div className="p-5 sm:p-6 flex-1 flex flex-col justify-between">
                        <div>
                          <div className="flex items-start justify-between gap-4 mb-5">
                            <div>
                              <div style={D} className="text-[10px] font-mono tracking-[0.25em] text-zinc-500 uppercase mb-1">TICKETZ — E-TICKET</div>
                        ...
                        {/* Trạng thái */}
                        <div className="mt-2">
                          <span className={`inline-flex items-center px-2.5 py-0.5 rounded-none text-[10px] sm:text-xs font-bold uppercase tracking-wider ${ticket.status === 'UNUSED' || ticket.status === 'VALID'
