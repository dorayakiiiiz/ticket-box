    ...
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white border border-gray-200 p-6">
          ...
          <div className="bg-gray-100 p-12 text-center mb-4">
            ...
            <button
              ...
              } text-white font-bold text-sm px-8 py-3 hover:bg-gray-800 transition-colors`}
            >
            ...
            <div className="space-y-3">
              {['VT-A1B2C3', 'VT-D4E5F6', 'VT-G7H8I9'].map((ticket, i) => (
                <div key={ticket} className="flex items-center justify-between py-2 border-b border-gray-100 last:border-0">
                  ...
                  <span className="text-xs font-bold px-2 py-1 bg-green-100 text-green-700">✓</span>
                </div>
              ))}
            </div>
          </div>
