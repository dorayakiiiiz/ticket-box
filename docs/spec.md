...
Template tham khảo theo cấu trúc của [OpenSpec](https://github.com/) — framework spec-driven development, gồm ba lớp tài liệu: proposal (vấn đề và lý do), design (giải pháp kỹ thuật), specs (kịch bản và ràng buộc cho từng tính năng). Nhóm có thể bổ sung mục hoặc điều chỉnh cấu trúc nếu phù hợp.
