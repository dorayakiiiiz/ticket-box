    ...
    <aside className="w-64 border-r border-gray-200 bg-white flex flex-col">
      <div className="p-6 border-b border-gray-200">
        <div style={D} className="text-2xl font-black tracking-tight">
          <span className="text-[#CCFF00]">VI</span><span className="text-gray-900">TICKET</span>
        </div>
      ...
      <div className="p-4 border-t border-gray-200">
        <button onClick={() => onNav({ page: "home" })} className="w-full flex items-center gap-3 px-3 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-lg transition-colors">
          <LogOut size={16} />
          Về trang chủ
        </button>
      </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-gray-400"
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-gray-400 resize-none"
          ...
          <div className="flex gap-3 pt-4 border-t border-gray-200">
            ...
            <button
              type="submit"
              className="flex-1 px-6 py-3 bg-gray-900 text-white font-bold rounded-lg hover:bg-gray-800 transition-colors">
    ...
    <AdminLayout active="dashboard" onNav={onNav}>
      <div className="p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <AdminStatCard title="Tổng doanh thu" value="48.5B đ" icon={<DollarSign size={20} />} trend="up" trendValue="+12.5%" />
          <AdminStatCard title="Vé đã bán" value="12,847" icon={<Ticket size={20} />} trend="up" trendValue="+8.2%" />
          <AdminStatCard title="Sự kiện đang bán" value="8" icon={<Calendar size={20} />} />
          <AdminStatCard title="Khách hàng" value="5,234" icon={<Users size={20} />} trend="up" trendValue="+15.3%" />
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg">
          <div className="p-6 border-b border-gray-200 flex items-center justify-between">
            ...
            <button onClick={() => onNav({ page: "admin-orders" })} className="text-sm font-semibold text-gray-600 hover:text-gray-900">Xem tất cả →</button>
          </div>
    ...
    <AdminLayout active="concerts" onNav={onNav}>
      <div className="p-8">
        <div className="flex items-center justify-between mb-8">
          ...
          <button onClick={handleAdd} className="bg-gray-900 text-white font-bold text-sm px-6 py-3 rounded-lg hover:bg-gray-800 transition-colors flex items-center gap-2">
        ...
        <div className="flex gap-4 mb-6">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 bg-white border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-gray-400"
            />
          </div>
          <button className="px-4 py-3 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors flex items-center gap-2 text-sm font-semibold text-gray-700">
            <Filter size={16} /> Lọc
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filtered.map(event => (
            <div key={event.id} className="bg-white border border-gray-200 rounded-lg overflow-hidden hover:border-gray-300 transition-colors">
    ...
    <AdminLayout active="users" onNav={onNav}>
      <div className="p-8">
        <div className="flex items-center justify-between mb-8">
          ...
          <button className="bg-gray-900 text-white font-bold text-sm px-6 py-3 rounded-lg hover:bg-gray-800 transition-colors flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <p style={D} className="text-3xl font-black text-gray-900">{ADMIN_USERS.length}</p>
          </div>
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <p className="text-sm font-medium text-gray-600 mb-2">Khán giả</p>
            <p style={D} className="text-3xl font-black text-gray-900">{ADMIN_USERS.filter(u => u.role === "AUDIENCE").length}</p>
          </div>
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <p className="text-sm font-medium text-gray-600 mb-2">Nhân viên</p>
            <p style={D} className="text-3xl font-black text-gray-900">{ADMIN_USERS.filter(u => u.role === "STAFF" || u.role === "ADMIN").length}</p>
          </div>
        </div>
  ...
  return (
    <AdminLayout active="guests" onNav={onNav}>
      <div className="p-8">
        ...
        {/* Upload Section */}
        <div className="bg-white border-2 border-dashed border-gray-300 rounded-lg p-12 mb-8 text-center hover:border-gray-400 transition-colors">
          ...
          <button className="bg-gray-900 text-white font-bold text-sm px-6 py-3 rounded-lg hover:bg-gray-800 transition-colors">
            Chọn file CSV
          </button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              ...
              <select className="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-gray-400 mb-4">
              ...
              <button
                ...
                disabled={processing}
                className="w-full bg-[#CCFF00] text-black font-bold text-sm px-6 py-3 rounded-lg hover:bg-[#B8E600] transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <div className="bg-gray-100 rounded-lg p-12 text-center mb-4">
              ...
              <button
                ...
                } text-white font-bold text-sm px-8 py-3 rounded-lg hover:bg-gray-800 transition-colors`}>
...
function Navbar({ onNav, onLogin }: { onNav: (s: PageState) => void; onLogin: () => void }) {
  ...
  return (
    <nav className="fixed top-0 inset-x-0 z-50 border-b border-border bg-[#080808]/95 backdrop-blur-sm">
      <div className="max-w-[1400px] mx-auto px-6 h-14 flex items-center justify-between gap-6">
        <button onClick={() => onNav({ page: "home" })} style={D}>
          <span className="text-2xl font-black tracking-tight"><span className="text-[#CCFF00]">VI</span><span className="text-foreground">TICKET</span></span>
        </button>
        <div className="hidden md:flex items-center gap-6 text-[11px] font-semibold uppercase tracking-[0.12em] text-muted-foreground">
          {["Sự Kiện", "Nghệ Sĩ", "Địa Điểm", "Khuyến Mãi"].map(l => (
            <button key={l} onClick={() => onNav({ page: "home" })} className="hover:text-foreground transition-colors">{l}</button>
          ))}
        </div>
      ...
      {open && (
        <div className="md:hidden border-t border-border bg-[#080808] px-6 py-4 flex flex-col gap-4 text-[12px] font-semibold uppercase tracking-[0.12em] text-muted-foreground">
          <button onClick={() => { onNav({ page: "home" }); setOpen(false); }} className="text-left hover:text-foreground">Sự Kiện</button>
          <a href="#" className="hover:text-foreground">Nghệ Sĩ</a>
          <a href="#" className="hover:text-foreground">Địa Điểm</a>
          <button onClick={() => { onLogin(); setOpen(false); }} className="text-left hover:text-foreground">Đăng nhập</button>
        </div>
      )}
    </nav>
  );
        ...
        <div className="p-5 flex flex-col gap-4">
          {tab === "register" && (
            <div className="relative">
              ...
              <input placeholder="Họ và tên" className="w-full bg-muted border border-border text-foreground text-sm pl-9 pr-3 py-3 outline-none focus:border-[#CCFF00]/50 placeholder-muted-foreground" />
            </div>
          )}
          <div className="relative">
            <Mail size={14} className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground" />
            <input type="email" placeholder="Email của bạn" className="w-full bg-muted border border-border text-foreground text-sm pl-9 pr-3 py-3 outline-none focus:border-[#CCFF00]/50 placeholder-muted-foreground" />
          </div>
          <div className="relative">
          ...
          <button className="border border-border text-sm py-3 flex items-center justify-center gap-3 text-foreground hover:border-[#CCFF00]/30 transition-colors">
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 py-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            <div className="col-span-2 md:col-span-1">
              <div style={D} className="text-3xl font-black tracking-tight mb-3"><span className="text-[#CCFF00]">VI</span>TICKET</div>
          ...
          <div className="border-t border-border pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-[11px] text-muted-foreground">© 2026 VITICKET. Bảo lưu mọi quyền.</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-10">
          <div>
            ...
            <button onClick={() => setAgreed(a => !a)} className="flex items-start gap-3 text-left mb-8">
              ...
              <span className="text-[11px] text-muted-foreground leading-relaxed">Tôi đã đọc và đồng ý với <span className="text-[#CCFF00]">Điều khoản sử dụng</span> và <span className="text-[#CCFF00]">Chính sách hoàn tiền</span> của VITICKET.</span>
            </button>
        ...
        <div className="relative overflow-hidden border border-white/10 bg-[#111]">
          ...
          <div className="p-7 pb-5">
            <div className="flex items-start justify-between gap-4 mb-7">
              <div>
                <div style={D} className="text-[10px] font-mono tracking-[0.25em] text-muted-foreground uppercase mb-1">VITICKET — E-TICKET</div>
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      {!hideNav && !isAdmin && <Navbar onNav={nav} onLogin={() => setLoginOpen(true)} />}
      {loginOpen && <LoginModal onClose={() => setLoginOpen(false)} />}

      <main className={!hideNav && !isAdmin && page.page !== "home" ? "pt-14" : ""}>
